...
func TestAddTypeImports(t *testing.T) {
	...
	imports1 := Set{
		...
		ThirdParty: List{
			`"github.com/wyverny/sqlboiler/v4/boil"`,
		},
	}
...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/wyverny/sqlboiler/v4", "github.com/volatiletech/null/v8"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/wyverny/sqlboiler/v4"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null/v8" && c.ThirdParty[1] != "github.com/wyverny/sqlboiler/v4" {
